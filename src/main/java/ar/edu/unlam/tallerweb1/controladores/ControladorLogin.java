...
public class ControladorLogin {
	...
	@RequestMapping(path = "/mostrar-usuarios", method = RequestMethod.GET)
	public ModelAndView mostrarUsuarios(@ModelAttribute("usuario") Usuario usuario, HttpServletRequest request) {
		ModelMap model = new ModelMap();

		// invoca el metodo consultarUsuario del servicio y hace un redirect a la URL /home, esto es, en lugar de enviar a una vista
		// hace una llamada a otro action a través de la URL correspondiente a ésta
		List<Usuario> usuarioBuscado = servicioLogin.devolverUsuario();
	...
	public ModelAndView eliminarUsuarios(@ModelAttribute("usuario") Usuario usuario, HttpServletRequest request, @PathVariable("id") Long idAEliminar) {
		ModelMap model = new ModelMap();

		servicioLogin.eliminarUsuario(idAEliminar);
		
		return new ModelAndView("redirect:/mostrar-usuarios");
	...
	public ModelAndView crearUsuarios(@ModelAttribute("usuario") Usuario usuario, HttpServletRequest request) {
		ModelMap model = new ModelMap();

		// invoca el metodo consultarUsuario del servicio y hace un redirect a la URL /home, esto es, en lugar de enviar a una vista
		// hace una llamada a otro action a través de la URL correspondiente a ésta

		return new ModelAndView("crearUsuario", model);
	}
